<div class="container">
    ...
    <div>
        ...
        <table class="table table-hover table-stripped">
            ...
            <td><input class="form-control" type="text" name="nome" value="<?php echo htmlspecialchars($cliente->nome, ENT_QUOTES, 'UTF-8'); ?>" required autofocus/></td></tr>
            <td><label>E-mail</label></td>
            <td><input class="form-control" type="email" name="email" value="<?php echo htmlspecialchars($cliente->email, ENT_QUOTES, 'UTF-8'); ?>" required /></td></tr>

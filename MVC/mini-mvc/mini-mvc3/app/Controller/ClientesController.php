...
class ClientesController
{
    ...
    public function index()
    {
        ...
        $todos = $Cliente->todosRegs(); // Todos os clientes e seus dados
        $soma = $Cliente->somaRegs();// Total de clientes, a soma

        // Carregar a view. Com as views nós podemoms mostrar $todos e a soma facilmente
        require_once APP . 'View/_includes/header.phtml';
        require_once APP . 'View/clientes/index.phtml';
    ...
    public function add()
    {
        ...
        if (isset($_POST['submit_add_cliente'])) {
            // Instance new Model (ClientesModel)
            $Cliente = new ClientesModel('clientes');
    ...
    public function edit($cliente_id)
    {
        ...
        if (isset($cliente_id)) {
            ...
            $Cliente = new ClientesModel('clientes');
            $todos = new Model('clientes');
            $todos = $todos->todosRegs();
